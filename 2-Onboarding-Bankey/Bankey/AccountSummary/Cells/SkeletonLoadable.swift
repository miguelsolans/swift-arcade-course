//
//  SkeletonProtocol.swift
//  Bankey
//
//  Created by Miguel Solans on 28/03/2023.
//
...
// extension will be available for whoever implements the protocol
// in other words, can be used in any view
